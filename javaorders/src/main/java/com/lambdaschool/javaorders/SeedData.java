...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String[] args) throws Exception {
        ...
        for (int i = 0 ; i < 100; i++){
            custNamesSet.add(faker.name().fullName());
        }
        for (String custName : custNamesSet){
            ...
            customer.setCustcity(faker.country().capital());
            customer.setCustcountry(faker.country().name());
            ...
            customer.setWorkingarea(faker.country().capital());
